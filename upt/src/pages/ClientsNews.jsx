...
function NewsPage() {
  ...
  return (
    <Box sx={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      {/* Титульник */}
      <Box sx={{ p: 2, position: 'sticky', top: 50, zIndex: 10, backgroundColor: '#fff' }}>
        <Typography variant="h4" align="center">
          Новости
        </Typography>
      </Box>
      {/* Меню новостей и кнопка добавить */}
      <Box sx={{ p: 2, top:100, backgroundColor: '#fff', position: 'sticky', zIndex: 11, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
